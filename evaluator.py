...
def _extract_prediction_tensors(model,
                                create_input_dict_fn, distance = 1000,
  ...
  """
  input_dict = create_input_dict_fn(distance=distance)
...
def evaluate(create_input_dict_fn, create_model_fn, eval_config, categories,
  ...
  """
  # eval_config.num_visualizations = eval_config.num_examples
  ...
  for distance,num_examples in sorted(range2num_map.iteritems()):
      print distance
      #######For all test#####
      distance = None
      num_examples=2812 ##2812 for close distance #3542 for long distance
      #########################
