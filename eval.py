...
flags.DEFINE_string('checkpoint_dir', 'Visible_close/train',
                    'Directory containing checkpoints to evaluate, typically '
                    'set to `train_dir` used in the training job.')
flags.DEFINE_string('eval_dir', 'expriments/IR_Night/eval',
                    'Directory to write eval summaries to.')
flags.DEFINE_string('pipeline_config_path', './faster_rcnn_resnet101_sensiac.config',
